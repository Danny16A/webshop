<header class="shadow-sm">
            ...
            <div class="topbar topbar-dark bg-dark">
                <div class="container">
                    ...
                    <div class="topbar-text dropdown d-md-none ms-auto"><a class="topbar-link dropdown-toggle" href="#" data-bs-toggle="dropdown">Wishlist / Track</a>
            ...
            <div class="navbar-sticky bg-light">
                <div class="navbar navbar-expand-lg navbar-light">
                    <div class="container"><a class="navbar-brand d-none d-sm-block me-3 flex-shrink-0" href="/"><img src="img/logo-dark.png" width="142" alt="Cartzilla"></a><a class="navbar-brand d-sm-none me-2" href="/"><img src="img/logo-icon.png" width="74" alt="Cartzilla"></a>
                        <!-- Search-->
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">Account</a>
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="dropdown-item" href="account-signin.html">Sign Up</a></li>
                                ...
                                <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="/about" data-bs-toggle="dropdown">About Us</a>
                                </li>
                            </ul>
                        </div>
                    </div>
